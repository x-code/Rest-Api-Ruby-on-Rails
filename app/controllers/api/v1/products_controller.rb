  ...
  module V1
    class ProductsController < ApplicationController
      def index
        ...
        productdetails = ProductDetail.find('sale_start_at DESC');
        render json: {status: 'success', message:'get all products', data:products, details:productdetails}, status: :ok
      end
